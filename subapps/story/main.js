...
socket.on('message', function(data) {
    ...
    $("#storylines").append("<li class='storyline'>" 
      + '<span class="time">' + moment(data.dataentry_time).format("h:mm:ss a") + "</span>" 
...
var grammar = tracery.createGrammar({
    ...
    "emotion_good" : "happy sad reflective morose proud".split(" "),
    "emotion_bad" : "happy sad reflective morose proud".split(" "),
    ...
    'drinking':['I am #drinking_emotions# drinking from a #drinking_size# #drinking_vessel# of #drinking_alcohol#.'],
    "drinking_size": "thimble-sized large huge ample generous tiny petite".split(" "),
    "drinking_vessel": "bottle cup mug flask flagon".split(" "),
    "drinking_alcohol": "wine tequila beer cider seltzer".split(" "),
    "drinking_emotions": ["#emotion_mellowly#"],

    'bathrooming':["I'm a little busy #bathroom_activity#."],
